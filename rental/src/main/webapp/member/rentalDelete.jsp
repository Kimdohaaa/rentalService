...
<body>
	...
	<thead>
		...
		<tr>
		<th>
			<button type="button" class="btn btn-primary" onclick="rentalDelete()" style="width : 200px; background-color: #212529; border: none;" >
				예약 취소                                            
			</button>
		</th>
		</tr>
	...
	<script src="/rental/JS/member/rentalUpdate.js"></script>
</body>
</html>